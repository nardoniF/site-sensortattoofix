...
window.STF_I18N = (function () {
  const STRINGS = {
    pt: {
      ...
      'pelicula.upsellHint': 'Vai no mesmo envio — aproveite o frete e adicione a película para o seu modelo.',
    ...
    en: {
      ...
      'pelicula.upsellHint': 'Ships in the same package — add a screen protector for your model while you checkout.',
