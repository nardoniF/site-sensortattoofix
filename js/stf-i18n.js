...
window.STF_I18N = (function () {
  const STRINGS = {
    pt: {
      ...
      'store.add': 'Adicionar',
      'store.buy': 'Comprar',
      'store.alsoOn': 'Também no Mercado Livre, Shopee, Amazon e TikTok Shop',
      ...
      'shipping.sourceEstimate': 'Estimativa máxima — valor real pode ser menor quando a API Correios estiver ativa',
    ...
    en: {
      ...
      'store.add': 'Add',
      'store.buy': 'Buy',
      'store.alsoOn': 'Also on Mercado Libre, Shopee, Amazon and TikTok Shop',
      ...
      'shipping.sourceEstimate': 'Maximum estimate — actual cost may be lower when Correios API is active',
