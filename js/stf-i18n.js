...
window.STF_I18N = (function () {
  const STRINGS = {
    pt: {
      ...
      'form.notesPhOptional': 'Opcional: diâmetro do sensor (mm), instruções de entrega…',
      ...
      'conta.forgotLink': 'Esqueci minha senha',
      'conta.forgotSending': 'Enviando…',
      'conta.forgotSent': 'Se existir uma conta com este e-mail, enviamos um link para redefinir a senha.',
      'conta.resetMismatch': 'As senhas não coincidem.',
      'conta.resetSaving': 'Salvando…',
      'conta.resetDone': 'Senha atualizada. Você já está logado.',
      ...
      'conta.cancelHint': 'Só é possível cancelar pedidos ainda não pagos. Depois do pagamento, fale conosco por e-mail ou WhatsApp.',
      'conta.cancelAlt.wait': 'Voltar e concluir o pagamento quando quiser',
      'conta.cancelAlt.support': 'Dúvida? Fale no WhatsApp / e-mail',
      'conta.cancelReasonLabel': 'Motivo',
      'conta.cancelNoteLabel': 'Detalhe (opcional, obrigatório em “Outro”)',
      'conta.cancelConfirm': 'Confirmar cancelamento',
      'conta.cancelConfirmAsk': 'Tem certeza que deseja cancelar este pedido?',
      'conta.cancelFailed': 'Não foi possível cancelar. Tente de novo ou fale conosco.',
      'conta.cancelReason.changed_mind': 'Desisti da compra',
      'conta.cancelReason.found_cheaper': 'Encontrei mais barato',
      'conta.cancelReason.wrong_product': 'Produto errado / não era o que eu queria',
      'conta.cancelReason.shipping_too_slow': 'Prazo de frete',
      'conta.cancelReason.payment_issue': 'Problema no pagamento',
      'conta.cancelReason.other': 'Outro',
      ...
      'conta.watch': 'Relógio',
      'conta.total': 'Total',
      'conta.tracking': 'Rastreio',
      'conta.trackShipment': 'Acompanhar envio',
      ...
      'selfTest.summaryRef': 'Pedido de teste: valor real {ref} — cobrança simbólica {pay}.',
      'selfTest.summaryPay': 'Pedido de teste — cobrança simbólica {pay}.',
      ...
      'status.confirmStripe': 'Confirmando pagamento…',
      ...
      'shipping.intlDocBlockedAggregated': 'Com acessórios no carrinho, só envio em encomenda internacional (não carta/documento).',
      ...
      'shipping.sourceEstimate': 'Estimativa por distância — valor real quando a API Correios estiver ativa',
    ...
    en: {
      ...
      'form.notesPhOptional': 'Optional: sensor diameter (mm), delivery instructions…',
      ...
      'conta.forgotLink': 'Forgot password?',
      'conta.forgotSending': 'Sending…',
      'conta.forgotSent': 'If an account exists for this email, we sent a reset link.',
      'conta.resetMismatch': 'Passwords do not match.',
      'conta.resetSaving': 'Saving…',
      'conta.resetDone': 'Password updated. You are signed in.',
      ...
      'conta.statusCancelled': 'Cancelled',
      'conta.cancelOrder': 'Cancel order',
      'conta.cancelHint': 'You can only cancel unpaid orders. After payment, contact us by email or WhatsApp.',
      'conta.cancelAlt.wait': 'Go back and complete payment when ready',
      'conta.cancelAlt.support': 'Questions? Contact WhatsApp / email',
      'conta.cancelReasonLabel': 'Reason',
      'conta.cancelNoteLabel': 'Details (optional; required for “Other”)',
      'conta.cancelConfirm': 'Confirm cancellation',
      'conta.cancelConfirmAsk': 'Are you sure you want to cancel this order?',
      'conta.cancelFailed': 'Could not cancel. Try again or contact us.',
      'conta.cancelReason.changed_mind': 'Changed my mind',
      'conta.cancelReason.found_cheaper': 'Found a better price',
      'conta.cancelReason.wrong_product': 'Wrong product / not what I wanted',
      'conta.cancelReason.shipping_too_slow': 'Shipping time',
      'conta.cancelReason.payment_issue': 'Payment issue',
      'conta.cancelReason.other': 'Other',
      ...
      'conta.watch': 'Watch',
      'conta.total': 'Total',
      'conta.tracking': 'Tracking',
      'conta.trackShipment': 'Track shipment',
      ...
      'selfTest.summaryPay': 'Test order — symbolic charge {pay}.',
      ...
      'status.confirmStripe': 'Confirming payment…',
      ...
      'shipping.intlDocBlockedAggregated': 'With accessories in your cart, only international parcel shipping is available (not letter/document).',
      ...
      'shipping.serviceDocument': 'International shipping (lens)',
      'shipping.serviceParcel': 'Tracked parcel (full kit)',
      'shipping.noticeDocument': '',
      'shipping.noticeParcel': '',
      'shipping.lensOnlyTitle': 'International shipping',
      'shipping.arrivesBy': 'Arrives by {date}',
