...
window.STF_I18N = (function () {
  const STRINGS = {
    pt: {
      ...
      'cart.remove': 'Remover',
      'pelicula.upsellTitle': 'Proteja a tela do seu relógio',
      'pelicula.upsellHint': 'Películas listadas para o modelo que você escolheu — adicione no mesmo envio.',
      'pelicula.add': 'Adicionar película',
      'pelicula.added': 'Película adicionada ao carrinho!',
      'pelicula.inCart': 'No carrinho',
      'agregados.upsellTitle': 'Complete seu pedido com acessórios',
      'agregados.upsellHint': 'Só aparecem acessórios cuja lista de modelos compatíveis inclui o relógio que você escolheu — tudo no mesmo envio.',
    ...
    en: {
      ...
      'cart.remove': 'Remove',
      'pelicula.upsellTitle': 'Protect your watch screen',
      'pelicula.upsellHint': 'Screen protectors listed for your selected watch model — add in the same shipment.',
      'pelicula.add': 'Add screen protector',
      'pelicula.added': 'Screen protector added to cart!',
      'pelicula.inCart': 'In cart',
      'agregados.upsellTitle': 'Complete your order with accessories',
      'agregados.upsellHint': 'Only accessories whose compatible-model list includes your selected watch are shown — same shipment.',
