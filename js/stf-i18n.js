...
window.STF_I18N = (function () {
  const STRINGS = {
    pt: {
      ...
      'cart.remove': 'Remover',
      'pelicula.upsellTitle': 'Acessórios compatíveis com seu modelo',
      'pelicula.upsellHint': 'No mesmo envio do seu pedido.',
      'pelicula.add': 'Adicionar película',
      'pelicula.added': 'Película adicionada ao carrinho!',
      'pelicula.inCart': 'No carrinho',
      'agregados.upsellTitle': 'Acessórios compatíveis com seu modelo',
      'agregados.upsellHint': 'No mesmo envio do seu pedido.',
    ...
    en: {
      ...
      'cart.remove': 'Remove',
      'pelicula.upsellTitle': 'Accessories compatible with your model',
      'pelicula.upsellHint': 'Ships in the same package as your order.',
      'pelicula.add': 'Add screen protector',
      'pelicula.added': 'Screen protector added to cart!',
      'pelicula.inCart': 'In cart',
      'agregados.upsellTitle': 'Accessories compatible with your model',
      'agregados.upsellHint': 'Ships in the same package as your order.',
