...
const RULES = [
  ...
  ['Offizieller Shop | Sensor TattooFix — Code, Puls & Training', 'Uradna trgovina | Sensor TattooFix — geslo, utrip in vadba'],
  ['Kasse | Sensor TattooFix — Offizieller Shop', 'Blagajna | Sensor TattooFix — Uradna trgovina'],
  ['Mein Konto | Sensor TattooFix', 'Moj račun | Sensor TattooFix'],
  ['Community (Beta) | Sensor TattooFix', 'Skupnost (beta) | Sensor TattooFix'],
  ['Wo kaufen | Sensor TattooFix — Code- & Pulsmessprobleme', 'Kje kupiti | Sensor TattooFix — geslo in utrip'],
  ...
  ['<span class="badge">Sensor TattooFix Linse</span>', '<span class="badge">Leča Sensor TattooFix</span>'],
