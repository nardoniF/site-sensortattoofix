...
const RULES = [
  ...
  ['Smartwatch fragt nach Passcode, misst Puls nicht oder bricht Training ab? | Sensor TattooFix', 'Pametna ura zahteva geslo, ne meri pulza ali prekine vadbo? | Sensor TattooFix'],
  ['Die Uhr fragt alle 10 Sekunden nach dem Passcode, misst den Puls nicht, trennt die Verbindung oder bricht das Training ab? Tattoo-Tinte blockiert oft den Sensor. Sensor TattooFix Linse — Apple Watch, Samsung, Garmin. 3N20-Technologie.', 'Ura vsakih 10 sekund zahteva geslo, ne meri pulza, prekine povezavo ali vadbo? Tinta tetovaže pogosto blokira senzor. Leča Sensor TattooFix — Apple Watch, Samsung, Garmin. Tehnologija 3N20.'],
  ['smartwatch fragt nach passcode, uhr passcode alle 10 sekunden, smartwatch ständig passcode, smartwatch pulsmessung funktioniert nicht, herzfrequenz funktioniert nicht, smartwatch misst puls nicht, sensor funktioniert nicht, smartwatch trennt verbindung, uhr verliert handgelenkserkennung, training bricht ab, apple watch passcode tattoo, apple watch herzfrequenz tattoo, samsung watch sensor, garmin herzfrequenz, smartwatch tattoo, handgelenkserkennung tattoo, Sensor TattooFix', 'pametna ura zahteva geslo, ura geslo vsakih 10 sekund, pametna ura nenehno geslo, pametna ura merjenje pulza ne deluje, srčni utrip ne deluje, pametna ura ne meri pulza, senzor ne deluje, pametna ura prekine povezavo, ura izgubi zaznavo zapestja, vadba se prekine, apple watch geslo tetovaža, apple watch srčni utrip tetovaža, samsung watch senzor, garmin srčni utrip, pametna ura tetovaža, zaznava zapestja tetovaža, Sensor TattooFix'],
  ['Smartwatch: Passcode oder Pulsmessung? | Sensor TattooFix', 'Pametna ura: geslo ali merjenje pulza? | Sensor TattooFix'],
  ...
  ['Sensor TattooFix — Smartwatch auf tätowierter Haut', 'Sensor TattooFix — Pametna ura na tetovirani koži'],
  ['Die Uhr fragt ständig nach dem Passcode, misst den Puls nicht oder trennt die Verbindung? Tattoo-Tinte kann den Sensor blockieren — entdecken Sie Sensor TattooFix.', 'Ura nenehno zahteva geslo, ne meri pulza ali prekine povezavo? Tinta tetovaže lahko blokira senzor — spoznajte Sensor TattooFix.'],
  ...
  ['<p><strong>Passcode alle 10 Sekunden</strong>, <strong>Puls wird nicht gemessen</strong>, <strong>Verbindung bricht ab</strong> oder <strong>Training wird unterbrochen</strong>? Auf tätowierten Handgelenken blockiert die Tinte den optischen Sensor. Stellen Sie Handgelenkserkennung, Herzfrequenz und Training auf Apple Watch, Samsung, Garmin und mehr wieder her — mit der Sensor TattooFix Linse (3N20).</p>', '<p><strong>Geslo vsakih 10 sekund</strong>, <strong>pulz se ne meri</strong>, <strong>povezava se prekine</strong> ali <strong>vadba se prekine</strong>? Na tetoviranih zapestjih tinta blokira optični senzor. Obnovite zaznavo zapestja, srčni utrip in vadbo na Apple Watch, Samsung, Garmin in drugih — z lečo Sensor TattooFix (3N20).</p>'],
  ...
  ['alt="Smartwatch misst Puls nicht oder fragt ständig nach Passcode am tätowierten Arm — Sensor TattooFix Apple Watch Sensor-Fix"', 'alt="Pametna ura ne meri pulza ali nenehno zahteva geslo na tetoviranem roki — Sensor TattooFix Apple Watch popravek senzorja"'],
  ...
  ['<p class="about-origin"><strong>Sensor TattooFix</strong> entstand aus einer echten Erfahrung.</p>', '<p class="about-origin"><strong>Sensor TattooFix</strong> je nastal iz resnične izkušnje.</p>'],
  ['<p class="about-body">Sensor TattooFix wurde nicht in einem fernen Labor oder mit geheimer Luft- und Raumfahrttechnik entwickelt. Es entstand in Imirim, Nordzone von São Paulo, im „Haus der Oma“ — wo ich geboren wurde und Jahre später, nachdem Oma Maria in den Himmel ging, mein Zuhause machte.</p>', '<p class="about-body">Sensor TattooFix ni nastal v oddaljenem laboratoriju ali s skrivno vesoljsko tehnologijo. Nastalo je v Imirimu, severni coni São Paula, v «Hiši babice» — kjer sem se rodil in leta pozneje, ko je babica Maria šla v nebesa, to mesto postal moj dom.</p>'],
  ...
  ['<p class="about-body">Mit wasserbeständiger Haftung und einer Linse, die Licht perfekt durch die Tinte bricht: voilà! Sensor TattooFix war geboren.</p>', '<p class="about-body">Z vodoodpornim lepljenjem in lečo, ki svetlobo popolnoma lomi skozi tinto: voilà! Sensor TattooFix je bil rojen.</p>'],
  ...
  ['<p class="about-body">Heute verkauft <strong>3N20</strong> die Sensor TattooFix Linse über unseren <strong>offiziellen Shop</strong> — PayPal und Karten, Sendungsverfolgung. Keine Tricks, kein Verlust von Gesundheitsfunktionen — Unterstützung von Menschen, die das Problem auf der Haut erlebt haben. Wörtlich.</p>', '<p class="about-body">Danes <strong>3N20</strong> prodaja lečo Sensor TattooFix prek naše <strong>uradne trgovine</strong> — PayPal in kartice, sledenje pošiljki. Brez trikov, brez izgube zdravstvenih funkcij — podpora ljudi, ki so problem doživeli na lastni koži. Dobesedno.</p>'],
  ...
  ['<p class="about-closing">Also: von einem Tätowierten zu anderen, die die Kunst ebenfalls bewundern — hier ist die wahre Geschichte von Sensor TattooFix.</p>', '<p class="about-closing">Torej: od tetoviranega do drugih, ki prav tako občudujejo to umetnost — tu je resnična zgodba Sensor TattooFix.</p>'],
  ['alt="Fábio Nardoni, Gründer von Sensor TattooFix"', 'alt="Fábio Nardoni, ustanovitelj Sensor TattooFix"'],
  ['<p class="about-signature-role">Gründer · Sensor TattooFix · 3N20</p>', '<p class="about-signature-role">Ustanovitelj · Sensor TattooFix · 3N20</p>'],
  ...
  ['value="Kontakt — Sensor TattooFix"', 'value="Kontakt — Sensor TattooFix"'],
